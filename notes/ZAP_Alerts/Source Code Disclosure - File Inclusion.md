...
other: "The output for the source code filename [../config/database.php] differs sufficiently from that of the random parameter [jzdysfaeeinxxtsvjfggrwaucugjvsvpawibnv], at [48%], compared to a threshold of [0%]"
cwe: 541
wasc: 33
alerttags: 
  - OWASP_2017_A06
